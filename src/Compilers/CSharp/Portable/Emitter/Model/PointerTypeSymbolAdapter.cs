...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
        ...
        Cci.IPointerTypeReference
    {
        ...
        {
            type := ((PEModuleBuilder)context.Module).Translate(AdaptedPointerTypeSymbol.PointedAtType, syntaxNodeOpt: (CSharpSyntaxNode?)context.SyntaxNode, diagnostics: context.Diagnostics);
